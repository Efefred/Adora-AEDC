...
// test('Grid Energy Profile: reachable from dashboard side menu', async ({ page }) => {
//   const login = new LoginPage(page);
//   const landing = new LandingPage(page);
//   const dashboard = new DashboardPage(page);
//   const gep = new GridEnergyProfilePage(page);
...
//   await test.step('Open Network Management dashboard', async () => {
//     await landing.assertLoaded();
//     await landing.openNetworkManagement();
//     await dashboard.assertLoaded();
//   });

//   await test.step('Navigate to Grid Energy Profile', async () => {
//     await dashboard.goToGridEnergyProfile();
//     //await dashboard.assertLoaded();
//   });
// });
