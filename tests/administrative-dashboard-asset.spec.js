...
//   title: 'Administrative Dashboard - Asset Communication Report',
//   fileName: 'admin-dashboard-asset-communication-report.html',
//   sections: [
//     {
...
//           title: '33KV Feeders',
//           metrics: {
//             Communicating: metrics.feeders33.communicating,
//             'Non Communicating': metrics.feeders33.nonCommunicating,
//             Total: metrics.feeders33.total
//           }
//         },
//         {
//           title: '11KV Feeders',
//           metrics: {
//             Communicating: metrics.feeders11.communicating,
//             'Non Communicating': metrics.feeders11.nonCommunicating,
//             Total: metrics.feeders11.total
//           }
//         },
//         {
//           title: 'Distribution Transformers',
//           metrics: {
//             Communicating: metrics.distributionTransformers.communicating,
//             'Non Communicating': metrics.distributionTransformers.nonCommunicating,
//             Total: metrics.distributionTransformers.total
//           }
//         }
//       ]
//     }
...
test.describe('Administrative Dashboard - Asset Communicating and Non-communicating Analysis', () => {
  ...
  test('should read communicating, non communicating and total values for 33KV Feeders, 11KV Feeders and Distribution Transformers', async ({ page }) => {
    ...
    await test.step('Read asset communication metrics', async () => {
      metrics = await administrativeDashboardPage.getAllAssetCommunicationMetrics();
